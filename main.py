    """
    Config Diff Ug5auaty
    ====================
    Zero-dependency command-line tool designed to archive local resources efficiently.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency command-line tool designed to archive local resources efficiently.")
